...
i)  whole genome alignments: [wg_3\_populations.txt](./docs/data files/wg_3_populations.txt) [wg_4\_populations.txt](./docs/data files/wg_4_populations.txt) [wg_3\_species.txt](./docs/data files/wg_3_species.txt) [wg_4\_species.txt](./docs/data files/wg_4_species.txt)

ii) cds alignments: [cds_3\_populations.txt](./docs/data files/cds_3_populations.txt)
[cds_4\_populations.txt](./docs/data files/cds_4_populations.txt)
[cds_3\_species.txt](./docs/data files/cds_3_species.txt)
[cds_4\_species.txt](./docs/data files/cds_4_species.txt)
